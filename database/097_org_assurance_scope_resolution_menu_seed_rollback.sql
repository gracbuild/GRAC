-- =====================================================================
-- 097 Scope Resolution menu seed rollback
-- =====================================================================
SET NOCOUNT ON;
GO
...
BEGIN
    UPDATE grac_practice.feature_flag_master
       SET is_active = 0, updated_by = 'rollback-097', updated_dt = SYSUTCDATETIME()
     WHERE feature_code IN (N'screen.org-assurance-scope-resolution');
END
GO

PRINT '097 rollback complete.';
GO
