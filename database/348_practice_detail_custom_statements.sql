-- =====================================================================
-- 348_practice_detail_custom_statements.sql
--
-- 347 follow-on: sp_practice_detail_get's MappedSourceStatementsJson
-- INNER JOINed GRAC_New.framework_statement, dropping custom-statement
-- mappings (framework_statement_id NULL). Switched to LEFT JOINs with a
-- custom_release_statement fallback so a practice's mapped CUSTOM
-- statements show in the Practice View too. Body is otherwise 316 verbatim.
-- Rollback: 348_practice_detail_custom_statements_rollback.sql (restores 316).
--
-- PURPOSE
...
PRINT '348: practice detail MappedSourceStatementsJson now includes custom statements.';
GO
