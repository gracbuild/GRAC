/*
  ...
  Purpose: Insert latest master/reference data
...
/* Idempotent master/reference seed blocks from the latest deployment baseline. */
/*
...
BEGIN
 ...
 USING (VALUES
  ...
  (N'repository-subscriptions',N'Standards & Frameworks',N'Practice/Index/repository-subscriptions',50,N'bookmark',N'Organization Setup'),
...
/* Additional reference/sample seed data. */
/*
  GRAC Part 2 - Practice Intelligence Layer
...
/* Security role and menu permission seed data. */
/*
  GRAC Part 2 - Practice Intelligence Layer
  RBAC seed.
*/
...
/* Latest incremental data normalizations. */
SET NOCOUNT ON;
GO
